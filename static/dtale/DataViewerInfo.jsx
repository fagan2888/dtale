...
class ReactDataViewerInfo extends React.Component {
  render() {
    ...
    const hideHidden = noHidden(this.props.columns);
    ...
    const unhide = () => {
      ...
      actions.updateVisibility(this.props.dataId, visibility, () =>
...
export { ReduxDataViewerInfo as DataViewerInfo, ReactDataViewerInfo, hasNoInfo, noHidden };
